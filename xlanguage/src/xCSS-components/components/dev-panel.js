...
function DevPanel() {
  ...
  new ClipboardJS('.clipboard-text-btn');
  ...
  return <div >
    ...
    <ButtonGroup fill style={{ marginTop: 10 }}>
      <Button intent="primary" icon="code" onClick={() =>{ 
        var MyDiv1 = document.getElementsByClassName('canvas-panel')[0];
        setDivData(MyDiv1.innerHTML);
        setIsOpenDiv(!isOpenDiv);} } >DIV TEXT</Button>
    </ButtonGroup>
    ...
    <div style={{
      ...
      <ButtonGroup fill>
        <Button data-clipboard-text={divData} intent="primary" className='clipboard-text-btn' icon="duplicate" onClick={showCopySuccessfullyMessage} >Copy</Button>
        <Button intent="danger" icon="cross" onClick={() => setIsOpenDiv(!isOpenDiv) } >Close</Button>
      </ButtonGroup>
        <div style={{ width:800, height: 800 }}>
          <div><pre style={{ width:800, height: 800, overflow: "scroll", whiteSpace: 'pre-line'}}>
