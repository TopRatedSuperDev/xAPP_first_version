  ...
  return (
    <div className="control-panel-group">
      ...
      <Collapse isOpen={isOpen}>
        {!disabled && <Switch id='backgroundGradientEnabled' onChange={onEnableGradientChange} className='background-gradient-switch' checked={enableGradient} label="Gradient" />}
          ...
          <FormGroup>
            <Popover2 disabled={enableGradient} content={
              ...
              <ControlGroup className='position-control' fill={true} vertical={false}>
                ...
                <InputGroup id="backgroundColor-input" disabled={enableGradient} value={color} onChange={() => { }} />
              </ControlGroup>
            </Popover2>
          </FormGroup>
        </div>}
