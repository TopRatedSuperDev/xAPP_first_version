...
function ActionPanel() {
  ...
  return <div className="control-panel-actions">
    ...
    <ButtonGroup fill style={{ marginTop: 10 }}>
      <Button onClick={ () => {  addNewElement() } } icon="add-clip" >New DIV</Button>
      <Button onClick={ () => {  addNewImageElement() } } icon="import">New IMAGE</Button>
    </ButtonGroup>
    <ButtonGroup fill style={{ marginTop: 10 }}>
      <Button onClick={ () => {  addNewTextElement() } } icon="new-text-box" > New TEXT</Button>
