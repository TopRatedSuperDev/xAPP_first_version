              ...
              {!collapsePanel && <div>
                <div className="control-panel-horizontal-layout">
                  <div className="control-panel-horizontal-layout-item">
                    <FormGroup label="Offset X" labelFor="offsetxInput">
                      <NumericInput
                        fill={true}
                        stepValue={1}
                        value={offsetX}
                  ...
                  <div className="control-panel-horizontal-layout-item">
                    <FormGroup label="Offset Y" labelFor="offsetYInput">
                      <NumericInput
                        fill={true}
                        stepValue={1}
                        value={offsetY}
                ...
                <div className="control-panel-horizontal-layout">
                  <div className="control-panel-horizontal-layout-item">
                    <FormGroup label="Blur Radius" labelFor="BlurRadius">
                      <NumericInput
                        fill={true}
                        stepValue={1}
                        value={blurRadius}
                  ...
                  <div className="control-panel-horizontal-layout-item">
                    <FormGroup label="Spread Radius" labelFor="SpreadRadius">
                      <NumericInput
                        fill={true}
                        stepValue={1}
                        value={spreadRadius}
                ...
                <div className="control-panel-horizontal-layout">
                  <div className="control-panel-horizontal-layout-item">
                    <FormGroup label="Inset" labelFor="InsetInput">
                      <Switch
                        id="InsetInput"
                        checked={enableInset}
                  ...
                  <div className="control-panel-horizontal-layout-item">
                    <FormGroup label="Color" labelFor='InsetColorInput'>
                      <Popover2 id="InsetColorInput" content={
                        ...
                        <ControlGroup className='position-control' fill={true} vertical={false}>
                          ...
                          <InputGroup id="InsetColorInput" value={color} onChange={() => { }} />
                        </ControlGroup>
                      </Popover2>
                    </FormGroup>
                  </div>
